...
double kp = 20, ki = 0.5, kd = 0.5;                        //Параметры ПИД регулятора по углу наклона
double kp_speed = 5, ki_speed = 0.1098, kd_speed = 0.0;  //Параметры ПИД регулятора по скорости движения
double kp_turn = 15, ki_turn = 0.7, kd_turn = 0.05;           //Параметры ПИД регулятора по углу поворота
